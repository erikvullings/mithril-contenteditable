  ...
  view: () =>
    m('.row', [
      m(
        '.col.s12.m7.l8',
        m('.introduction', [
          m('h2', 'About mithril-contenteditable'),
          m('p', [
          ...
          m('p', [
            ...
            m('a[href="https://erikvullings.github.io/mithril-contenteditable/typedoc/index.html"]', 'here'),
            '.',
          ]),
          m('h3', 'Installation'),
          ...
          m(CodeBlock, {
            language: 'console',
            code: `npm i mithril mithril-contenteditable
